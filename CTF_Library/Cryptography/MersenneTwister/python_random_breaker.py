class python_random_breaker:
	from CTF_Lib.Cryptography.MersenneTwister.mersenne_twister import mt19937 as mt
	from CTF_Lib.Cryptography.BitVector.bit_vector import make_bit_vector
	from CTF_Lib.Cryptography.LinearAlgebra.linear_equation_solver_GF2 import linear_equation_solver_GF2
	W = mt.W
	N = mt.N
	M = mt.M
	R = mt.R
