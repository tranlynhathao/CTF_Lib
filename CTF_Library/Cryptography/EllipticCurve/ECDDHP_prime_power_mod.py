...
def ECDDHP_prime_power_mod(p: int, e: int, coef: list, P: tuple, Q: tuple, targets: list, threshold: int = 2**40, threshold2: int = 2**50):
	...
	from CTF_Lib.Cryptography.EllipticCurve.EC_coordinate_normalizer import EC_coordinate_normalizer
	from CTF_Lib.Cryptography.EllipticCurve.ECDLP_prime_power_mod import ECDLP_prime_power_mod
	from CTF_Lib.Cryptography.EllipticCurve.custom_elliptic_curve import custom_elliptic_curve
